...
public final class Main
{
	...
	public static void main(String[] argv)
	{
		...
		System.out
				.println("For more information on JIntellitype please visit http://www.melloware.com");
	}
	...
	private static String getProjectVersion()
	{
		...
		try
		{
			...
			pomProperties
					.load(Main.class
							.getResourceAsStream("/META-INF/maven/com.melloware/jintellitype/pom.properties"));
