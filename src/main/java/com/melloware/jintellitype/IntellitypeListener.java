 ...
 * that had special keys for Play, Pause, Stop, Next etc for controlling Media
 * applications like Windows Media Player, Itunes, and Winamp.
 * <p>
 * If you have ever wanted your Swing/SWT application to respond to these global
 * events you now can with JIntellitype. Just implement this interface and you
 * can now take action when those special Media keys are pressed.
 * <p>
 ...
 *      keyboardinputmessages/wm_appcommand.asp
 */
public interface IntellitypeListener
{
	 ...
	 * 
	 * @param command
	 *            the WM_APPCOMMAND that was pressed
	 */
