...
public class EditorPanel extends JPanel implements MouseMotionListener,
	...
	private void drawBorderedRectangle(Graphics2D g) {
		...
		g.fillRect((int) (draggedRect().getX() + draggedRect().getWidth())
				+ (int) (stroke_correction / 2), (int) draggedRect().getY()
				+ stroke_correction, stroke_correction, (int) draggedRect()
				.getHeight() - (int) (stroke_correction / 2));
		g.fillRect((int) (draggedRect().getX() + stroke_correction),
				(int) (draggedRect().getY() + draggedRect().getHeight())
						+ (int) (stroke_correction / 2), (int) draggedRect()
		...
		g.setColor(fillColor);
		g.fill(new Rectangle(draggedRect().x + (int) (stroke_correction / 2),
				draggedRect().y + (int) (stroke_correction / 2),
				draggedRect().width - (int) (stroke_correction / 2),
