...
/**
 * Listener interface for Windows Hotkey events registered using the Windows API
 * call RegisterHotKey to globally listen for a key combination regardless if
 * your application has focus or not.
 * <p>
...
public interface HotkeyListener
{
	 ...
	 * 
	 * @param identifier
	 *            the unique Identifer the Hotkey was assigned
	 */
