...
public class MultiUploader extends JFrame
{
	...
	public MultiUploader()
	{
		...
		ImageIcon ii2 = new ImageIcon(this.getClass().getResource(
				"/images/icons/multi-image.png"));
		this.setIconImage(ii2.getImage());

		JPanel panel = new JPanel();
		contentPane.add(panel, BorderLayout.CENTER);
		panel.setLayout(new MigLayout("", "[423.00,grow][-4.00]",
				"[169.00,center][25.00][114.00,grow][]"));

		JScrollPane scrollPane = new JScrollPane();
		scrollPane
				.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
		scrollPane.setBorder(BorderFactory
				.createTitledBorder("Drag images here"));
		...
		scrollPane_1
				.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
		scrollPane_1
				.setBorder(BorderFactory.createTitledBorder("Upload Links"));
		...
		scrollPane_2.setBorder(BorderFactory
				.createTitledBorder("Deletion Links"));
