...
public class Main extends JFrame implements ActionListener
{
	...
	private void initializeNotifications()
	{
		...
		infoNotification.setBorder(BorderFactory.createLineBorder(new Color(
				255, 255, 25, 200), 2, false));
		...
		errorNotification.setBorder(BorderFactory.createLineBorder(new Color(
				255, 0, 0, 200), 2, false));
	...
	private void initializeHotkeys()
	{
		...
		keyhook.registerHotKey(5, JIntellitypeConstants.MOD_ALT
				+ JIntellitypeConstants.MOD_SHIFT, '1');
		keyhook.registerHotKey(6, JIntellitypeConstants.MOD_CONTROL
	...
	private void initializeTray()
	{
		...
		utilitiesMenu.setIcon(new ImageIcon(this.getClass().getResource(
				"/images/icons/utilities.png")));
		JMenuItem imageViewer = new JMenuItem("Capture Viewer");
		imageViewer.addActionListener(this);
		imageViewer.setActionCommand("viewer");
		imageViewer.setIcon(new ImageIcon(this.getClass().getResource(
		...
		uClipboardImg.setIcon(new ImageIcon(this.getClass().getResource(
				"/images/icons/image_upload.png")));
		...
		if (os.indexOf("Win") >= 0) // Only do this if your in windows
		{
			...
			{
				tray.add(trayIcon);
				displayInfoMessage("Snipping Tool++",
		...
		} else
		{
			...
			trayIcon.addMouseListener(new MouseListener()
			{
				...
				{
					trayIcon.setImage(new ImageIcon(this.getClass()
							.getResource("/images/" + iconPressedMac))
							.getImage());
					if (e.getButton() == MouseEvent.BUTTON1)
					{
						JOptionPane.showMessageDialog(null,
								"Pointer Location: OOOh a message");
				...
				{
					trayIcon.setImage(new ImageIcon(this.getClass()
							.getResource("/images/" + iconMac)).getImage());
	...
	public static void doNotificatoinAction()
	{
		...
		{
			Desktop.getDesktop()
					.open(new File(Preferences.DEFAULT_CAPTURE_DIR));
		} catch (IOException e)
		{
