...
public class SlidingNotification extends Notification
{
		...
		this.fadeInTimer = new Timer(fadeInTimerRate, new ActionListener() 
		 {
				...
				public void actionPerformed(ActionEvent e) 
	            {
	               ...
	               if (currOpacity <= finalOpacity) 
	               {
	            	  ...
	            	  setBackground(new Color(backgroundColor.getRed(), backgroundColor.getGreen(), backgroundColor.getBlue(), o));
	            	  lblTitle.setForeground(new Color((titleColor.getRed()), (titleColor.getGreen()), (titleColor.getBlue()),o));
	            	  lblMessage.setForeground(new Color(messageColor.getRed(),messageColor.getGreen(),messageColor.getBlue(),o));
	...
	{
		if(rounded_notification)
			this.setShape(new RoundRectangle2D.Double(0, 0, this.getWidth(), this
							.getHeight(), 20, 20));
		else
			this.setShape(null);
	}
